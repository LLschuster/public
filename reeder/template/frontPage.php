<?php  include ('include/header.php')?>
					...
					<h3>Estadisticas</h3>
						<ul>
							<li>total de usuarios: <strong><?php echo $numberUsers;?></strong></li>
							<li>total de topicos: <strong><?php echo $numberTopics;?></strong></li>
							<li>total de categorias: <strong><?php echo $numberCategories;?></strong></li>
						</ul>
